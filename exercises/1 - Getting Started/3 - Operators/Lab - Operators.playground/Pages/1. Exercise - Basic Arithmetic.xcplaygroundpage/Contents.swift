...
// The resulting value in divisionResult is of the datatype 'Double'
/*:
...
//If division by 2 results in remainder 0, then the number is even, otherwise the number is odd.
/*:
