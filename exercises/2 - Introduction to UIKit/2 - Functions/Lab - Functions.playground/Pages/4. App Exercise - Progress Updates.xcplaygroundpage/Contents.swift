 ...
 */
func progressUpdate(steps: Int, goal: Int) -> Int{
...
func pacing(currentDistance: Double, totalDistance: Double, currentTime: Double, goalTime: Double) {
    ...
    currentSpeed >= goalSpeed ? print("Keep it up!") : print("You've got to push it just a bit harder!")
}

pacing(currentDistance: 600, totalDistance: 1000, currentTime: 50, goalTime: 100)
