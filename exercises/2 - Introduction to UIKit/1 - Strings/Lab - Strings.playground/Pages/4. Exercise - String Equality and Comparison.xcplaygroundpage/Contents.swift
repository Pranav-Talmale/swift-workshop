 ...
 */
nameInCaps.lowercased() == name.lowercased() ?
...
junior.hasSuffix("Jr.") ? print("We found a second generation name!") : print("oof")
...
textToSearchThrough.lowercased().contains(textToSearchFor.lowercased()) ? print("I found it!"): print("I did not find it.")
